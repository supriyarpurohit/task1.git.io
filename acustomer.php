...
<div class="row">
    ...
    <div style="padding-top:2%;display:inline;"><h4 class="font-weight-bold" style="color:blue;font-size:2em;;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Customer Details</h4>
    </div>
        <br><br>
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                    ...
                    <span class="font-weight-bold" style="color:blue;font-size:1.8em;line-height:1em;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Money Transfer</span>
                    </div><br><br>
