...
<head>
    ...
    <!-- Icon -->
    <link rel="icon" height="50px" href="./images/bank.png">
</head>
...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        <!--Navbar-->
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:lightblue; opacity:1;"> 
            <img  height="90"src="./images/bg2.png">
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:darkblue;font-family: 'Courgette', cursive;font-size:2em;">
                &nbsp;Sparks Bank
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="color:darkgreen;font-weight:1em;">
                            <div style="padding-left:20px;" >
                                <img height="60"src="./images/transaction.png">
                            </div>
                            Transfer Records
                        </a> 
                    </li>  
...
<div class="usertable">
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:darkblue;font-family: 'Courgette', cursive;font-size:2.2em;padding:3%;">Customers</h3>
    <table id="myTable">
          <tr>
            <th>Customer ID</th>
            <th>Name</th>
...
<!-- Footer -->
<div class="footer">
   <span style="font-family:verdana;">&copy;</span> 2020 Sparks Bank.By supriya purohit.
</div>
</body>
