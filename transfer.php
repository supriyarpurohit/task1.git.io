...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        <!--Navbar-->
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:blue; opacity:1;"> 
            <img  height="90"src="./images/iconimg.png">
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:blue;font-family: 'Courgette', cursive;font-size:2em;">
                &nbsp;Sparks Bank
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                <ul class="navbar-nav ml-auto font-weight-bold"  style="font-size:small; color:blue; "> 
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:blue;font-weight:1em;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="viewcustomers.php" style="color:blue;font-weight:1em;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="color:blue;font-weight:1em;">
                            <div style="padding-left:20px;" >
